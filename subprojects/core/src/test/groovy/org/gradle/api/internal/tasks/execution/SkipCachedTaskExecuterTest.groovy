...
class SkipCachedTaskExecuterTest extends Specification {
    ...
    def executer = new SkipCachedTaskExecuter(taskOutputOriginFactory, buildCacheConfiguration, taskOutputPacker, internalTaskExecutionListener, delegate, taskCachingReasonsListener, cacheHashesListener)
